...
namespace TLabs.ExchangeSdk.Depository
{
    ...
    public class TransactionType
    {
        ...
        public static readonly TransactionType DepositStakingToBonuses = new TransactionType("1041", "Безусловное пополнение бонусного баланса стейкингом", nameof(DepositStakingToBonuses));
        ...
        public static readonly TransactionType DepositCorrectionToOnOrders = new TransactionType("1091", "Корректировочное пополнение средств на OnOrders", nameof(DepositCorrectionToOnOrders));
        ...
        public static readonly TransactionType PaymentCardMerchantPoolRechargeCancel = new TransactionType("944", "Отмена пополнения merchant pool Bananatech", nameof(PaymentCardMerchantPoolRechargeCancel));
        ...
        public static readonly List<TransactionType> All = new List<TransactionType>
        {
            ...
            PaymentCardMerchantPoolRechargeBegin, PaymentCardMerchantPoolRechargeEnd, PaymentCardMerchantPoolRechargeCancel,
