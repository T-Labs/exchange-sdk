...
namespace TLabs.ExchangeSdk.Depository
{
    public class AccountChart
    {
        ...
        public static readonly AccountChart DepositToGlobal = new AccountChart("56", "Введеные средства на фонды", nameof(DepositToGlobal));
        ...
        public static readonly List<AccountChart> All = new List<AccountChart>(UsersPersonalCharts)
        {
            ...
            Deposit, DepositAdmin, DepositCash, DepositStaking, DepositAirdrop, DepositToGlobal, DepositReplacement, DepositCorrection,
        ...
        {
            Deposit, DepositToGlobal, Withdrawn, NetworkComission,
        };
